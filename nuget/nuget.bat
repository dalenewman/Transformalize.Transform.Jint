...
REM nuget push "c:\temp\modules\Transformalize.Transform.Jint.3.0.7.6-beta.nupkg" -source https://api.nuget.org/v3/index.json
REM nuget push "c:\temp\modules\Transformalize.Transform.Jint.3.Autofac.0.7.6-beta.nupkg" -source https://api.nuget.org/v3/index.json
REM 
REM nuget push "c:\temp\modules\Transformalize.Validate.Jint.3.0.7.6-beta.nupkg" -source https://api.nuget.org/v3/index.json
REM nuget push "c:\temp\modules\Transformalize.Validate.Jint.3.Autofac.0.7.6-beta.nupkg" -source https://api.nuget.org/v3/index.json
